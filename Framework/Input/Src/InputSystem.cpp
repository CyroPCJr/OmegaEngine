...
{
	OMEGAASSERT(sInputSystem == nullptr, "[InputSystem] System already initialized!");
...
{
	OMEGAASSERT(!mInitialized, "[InputSystem] Terminate() must be called to clean up!");
}
...
{
	OMEGAASSERT(mInitialized, "[InputSystem] System not initialized.");
